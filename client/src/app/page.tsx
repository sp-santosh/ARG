              ...
              <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                <div className="sm:text-center lg:text-left">
                  ...
                  <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                    Welcome to the Routine Generator Dashboard. This tool
                    utilizes genetic algorithms to automatically create
                    optimized routines for colleges based on various constraints
                    and preferences.
                  </p>
              ...
              <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                <div className="relative">
                  ...
                  <dd className="mt-2 ml-16 text-base text-gray-500">
                    The generator uses genetic algorithms to efficiently
                    optimize college routines, ensuring they meet various
                ...
                <div className="relative">
                  ...
                  <dd className="mt-2 ml-16 text-base text-gray-500">
                    Users can specify custom constraints and preferences, such
                    as class timings, teacher availability, and room
                    allocations, to tailor the generated routines according to
                    their needs.
                  </dd>
                </div>
              </dl>
